...
Puruto does **not** include an agent or LLM model. To use commands like `/init` and `/puruto-generator` you need a `SKILL.md`-compatible agent (for example Claude Code, Codex, Gemini CLI or Windsurf). Otherwise, you can use the framework via CLI with Python scripts.
:::
